...
test('Line.distance', () => {
    ...
    const distanceTests = [
        ...
        },
        {
            ...
            point: new Vector2(22, 3),
            closestPoint: new Vector2(0, 3),
        },
        {
            line: new Line({
                origin: Vector2.zero,
        ...
        },
        {
            ...
            point: new Vector2(-13, 153),
            closestPoint: new Vector2(-13, 0),
        },
        {
            line: new Line({
                origin: Vector2.zero,
        ...
        },
        {
            ...
            closestPoint: new Vector2(0.5, 0.5),
        },
    ];

    for (const { line, point, closestPoint } of distanceTests) {
        console.log(line.closestPoint(point));
        expect(line.closestPoint(point).almostEquals(closestPoint)).toBeTruthy();
        expect(line.distance(point)).toBeCloseTo(point.distanceTo(closestPoint), numDigits);
    }
});
