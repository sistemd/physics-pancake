...
test('Vector.normal', () => {
    ...
    v = new Vector(-5, -10);
    expect(v.normal(new Vector(0, 1).almostEquals(new Vector(-1 / sqrt5, 2 / sqrt5)))).toBeTruthy();
    expect(v.normal(new Vector(1, 0).almostEquals(new Vector(-1 / sqrt5, -2 / sqrt5)))).toBeTruthy();
    expect(v.normal(new Vector(20, 19).almostEquals(new Vector(-1 / sqrt5, 2 / sqrt5)))).toBeTruthy();
    expect(v.normal(new Vector(0, -1).almostEquals(new Vector(-1 / sqrt5, -2 / sqrt5)))).toBeTruthy();
    expect(v.normal(new Vector(-1, 0).almostEquals(new Vector(-1 / sqrt5, 2 / sqrt5)))).toBeTruthy();
    expect(v.normal(new Vector(-18, -20).almostEquals(new Vector(-1 / sqrt5, -2 / sqrt5)))).toBeTruthy();
});
